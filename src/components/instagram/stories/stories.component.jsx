...
import { fetchStoryPostsAdd } from '../../../redux/instagram/instagram.actions';
import { connect } from 'react-redux';
import { checkUserSession } from '../../../redux/user/user.actions';

import '../instagram.styles.scss';

const Stories = ({ fetchStoryPostsAdd, checkUserSession }) => {
  ...
  const handleSubmit = (event) => {
    ...
    history.push('/instagram/story-posts');
  };
    ...
    <div className="home-section">
      ...
      <div className="home-container">
        <div className="options-ig card">
          ...
          <Link to="/instagram/stories" className="btn options-ig--active">
            <span>Pro</span>
            <p>Stories</p>
          </Link>
        </div>
